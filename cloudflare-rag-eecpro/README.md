...
- **Local ChromaDB:** `eplan-eecpro-rag-builder/rag_db_llama_chroma/` in a separate source checkout. Set `EEC_PRO_CHROMA_DB_PATH` before re-exporting; the index is already deployed to Vectorize.
